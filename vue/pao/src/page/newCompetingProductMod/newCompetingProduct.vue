<template>
  <div id="newCompetingProduct">
            <div class="closeNav">
              <p class=" tit fl">新建竞品</p>
              <div>
                ...
                <el-tabs v-model="activeName" @tab-click="handleClick">
                    <el-tab-pane label="项目基本信息" class="basicProjectInformation" name="first">
                      <div style="height: 150px;" status-icon  label-width="100px" class="demo-ruleForm form" >
                        <el-form-item label="项目名称" prop="name" class="proAddress mandatory01">
                          <el-input  :maxlength="140" placeholder="市+区县+街道+道路名或地标名+出让编号（说明：实际名称中不要加号" v-model="ruleForm2.name"></el-input>
                        </el-form-item>
                          ...
                          <div >
                            ...
                            <el-col :span="8">
                              <el-form-item label="获取单价" prop="getUnitPrice">
                                <el-col :span="16"> <el-input v-model="ruleForm2.getUnitPrice"></el-input></el-col>
                                <el-col :span="8"><span>元/平米</span></el-col>
                              </el-form-item>
                            </el-col>
                            <el-col :span="8">
                              <el-form-item label="交付标准" prop="pass">
                                <el-col :span="18"> <el-select v-model="ruleForm2.handoverStandard" placeholder="请选择"><el-option
                          ...
                          <div >
                            <el-col :span="8">
                              <el-form-item label="建设用地面积" prop="constructionLandArea">
                                <el-col :span="18"> <el-input v-model="ruleForm2.constructionLandArea"></el-input></el-col>
                                <el-col :span="6"><span>平米</span></el-col>
                              </el-form-item>
                            </el-col>
                            <el-col :span="8">
                              <el-form-item label="综合容积率" prop="plotRatio">
                                <el-col :span="18"> <el-input  v-model="ruleForm2.plotRatio"></el-input></el-col>
                                <el-col :span="6"><span></span></el-col>
                              </el-form-item>
                            </el-col>
                            <el-col :span="8">
                              <el-form-item label="建筑面积" prop="buildingConstructionArea">
                                <el-col :span="18"> <el-input  v-model="ruleForm2.buildingConstructionArea"></el-input></el-col>
                                <el-col :span="6"><span>平米</span></el-col>
                              </el-form-item>
                            </el-col>
                          </div>
                          ...
                          <div>
                            <el-col :span="8">
                              <el-form-item label="开发商" prop="pass">
                                <el-col :span="18"> <el-select v-model="ruleForm2.developer" placeholder="请选择"><el-option
                      ...
                      <div class="imageManagement">
                        <el-form  status-icon  label-width="100px" class="demo-ruleForm form" >
                          <el-form-item label="成交信息" class="proPhoto"  >
                            <heavyImageManagement @componentDataSynchronization="formatPicturecomponentDataSynchronization" :picturesRef="formatPicture"  :btnNone="btnNone" :dictionariesList="formatPicturedictionariesList" :dictionariesTitle="formatPicturedictionariesTitle"></heavyImageManagement>
                          </el-form-item>
                        </el-form>
                      </div>
                      <el-form  label-width="100px" class="demo-ruleForm form" >
                        <el-form-item>
                          <div style="clear: both;height:40px;margin-top: 5px;">
                            <el-button type="primary"  class="button" style="float: right;" @click="addDoneInformation()">添加</el-button>
                          </div>
                                ...
                                <div>
                                  <el-col :span="8">
                                    <el-form-item label="业态类型" prop="pass">
                                      <el-col :span="24"> <el-select v-model="item.runningType" placeholder="请选择"><el-option
                                  ...
                                  <el-col :span="8">
                                    <el-form-item label="售价" prop="sellingPrice">
                                      <el-col :span="12"> <el-input v-model="item.sellingPrice"></el-input></el-col>
                                      <el-col :span="12"><span>元/平米</span></el-col>
                                    </el-form-item>
                                  </el-col>
                                  <el-col :span="8">
                                    <el-form-item label="占比面积" prop="areaProportion">
                                      <el-col :span="18"> <el-input v-model="item.areaProportion"></el-input></el-col>
                                      <el-col :span="6"><span>%</span></el-col>
                                    </el-form-item>
                                  </el-col>
                                </div>
                                ...
                                <div>
                                  <el-col :span="8">
                                    <el-form-item label="月度成交量" prop="tradeCount">
                                      <el-col :span="14"> <el-input v-model="item.tradeCount"></el-input></el-col>
                                      <el-col :span="10"><span>平方米</span></el-col>
                                    </el-form-item>
                                  </el-col>
                                  <el-col :span="8">
                                    <el-form-item label="月度供应量" prop="tradeSupply">
                                      <el-col :span="16"> <el-input v-model="item.tradeSupply"></el-input></el-col>
                                      <el-col :span="8"><span>平方米</span></el-col>
                                    </el-form-item>
                                  </el-col>
                                  <el-col :span="8">
                                    <el-form-item label="当前库存量" prop="tradeStock">
                                      <el-col :span="16"> <el-input v-model="item.tradeStock"></el-input></el-col>
                                      <el-col :span="8"><span>平方米</span></el-col>
                                    </el-form-item>
                                  </el-col>
                                </div>
                                ...
                                <div>
                                  <el-col :span="8">
                                    <el-form-item label="月度成交均价" prop="finalPrice">
                                      <el-col :span="12"> <el-input v-model="item.finalPrice"></el-input></el-col>
                                      <el-col :span="12"><span>元/平方米</span></el-col>
                                    </el-form-item>
                                  </el-col>
                                  <el-col :span="8">
                                    <el-form-item label="去化周期" prop="sellPeriod">
                                      <el-col :span="18"> <el-input v-model="item.sellPeriod"></el-input></el-col>
                                      <el-col :span="6"><span>月</span></el-col>
                                    </el-form-item>
                                  </el-col>
                                  <!--<el-col :span="8">-->
                                    <!--<el-form-item label="月均销售套数" prop="sellingNums">-->
                                      <!--<el-col :span="18"> <el-input v-model="item.sellingNums"></el-input></el-col>-->
                    ...
                    <div class="componentBox">
                      <div class="titleComponentName position">
                        ...
                        <span class="addButton" @click="addCompetitiveProducts">添加({{competitors==undefined?0:competitors.length}}个)</span>
...
//          planedLandTitle:[],//规划用地性质
        ...
        /*产品规划图*/  /*产品规划图*/  /*产品规划图*/
        /*是否显示照片管理*/
        productPlanningDiagramisSwitchImgMangagement: false,
        /*存储图片管理中的信息*/
        productPlanningDiagramimgMangagement:[
          {}
        ],
        /*存储图片管理中封面的信息*/
        productPlanningDiagramimgCover:[
          {
            src:'',
            title:'',
            shortSrc:'',
        ...
        /*存储图片管理中四至的信息*/
        productPlanningDiagramimgFourto:[
          {
            src:'',
            title:'',
            shortSrc:'',
        ...
        /*存储图片管理中有利因素的信息*/
        productPlanningDiagramimgFavourableFactor:[
          {
            src:'',
            title:'',
            shortSrc:'',
        ...
        /*存储图片管理中不利因素的信息*/
        productPlanningDiagramimgNegativeFactor:[
          {
            src:'',
            title:'',
            shortSrc:'',
        ...
        /*存储图片管理中现状的信息*/
        productPlanningDiagramimgActuality:[
          {
            src:'',
            title:'',
            shortSrc:'',
        ...
        productPlanningDiagramtheInitImgData:[],
        /*产品规划图*/  /*产品规划图*/  /*产品规划图*/

        /*热销户型图*/  /*热销户型图*/  /*热销户型图*/
        /*是否显示照片管理*/
        hotHouseisSwitchImgMangagement: false,
        /*存储图片管理中的信息*/
        hotHouseimgMangagement:[
          {}
        ],
        /*存储图片管理中封面的信息*/
        hotHouseimgCover:[
    ...
    methods:{
      ...
      addCompetitiveProducts () {
        ...
        if (that.CompetitiveProducts.length > 0) {
          ...
          this.$http({
            ...
            data: {"inputType":1, "cityCode":that.cityCode}
          }).then(function (succeed) {
            that.CompetitiveProducts = succeed.data.result
            for (let i = 0; i < that.CompetitiveProducts.length; i++) {
              if(that.parm.competitors.length>0){
                for (let j = 0; j < that.parm.competitors.length; j++) {
                  if (that.CompetitiveProducts[i].projectId == that.parm.competitors[j].projectId) {
            ...
            for (let i = 0; i < that.parm.competitors.length; i++) {
              that.temporaryRight.push(that.parm.competitors[i])
            }
            that.temporaryLift = that.CompetitiveProducts
            that.CompetitiveProductsIsShow = true
          })
      ...
      affirmBtn () {
        ...
        this.parm.competitors = this.competitors
        console.log(this.parm.competitors)
      },
      closeBtn () {
        this.CompetitiveProductsIsShow = false
      },
      ...
      delAffirm (projectId) {
        ...
        this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
          ...
          for (var i = 0; i < that.parm.competitors.length; i++) {
            if (projectId ==that.parm.competitors[i].projectId) {
              that.parm.competitors.splice(i, 1)
...
//          that.ruleForm2.landEdge=competingProductData.landEdge;//描边
          ...
          if(competingProductData.transactionInformation.length>0){
            that.ruleForm2.transactionInformation=competingProductData.transactionInformation;//占比面积（%）
          }
          that.ruleForm2.areaProportion=competingProductData.areaProportion;//占比面积（%）
          that.ruleForm2.tradeSupply=competingProductData.tradeSupply;//月度供应量（平方米）
          that.ruleForm2.tradeCount=competingProductData.tradeCount;//月度成交量（平方米）
          that.ruleForm2.sellingPrice=competingProductData.sellingPrice;//售价（元/平米）
          that.ruleForm2.finalPrice=competingProductData.finalPrice;//月度成交均价（元/平方米）
          that.ruleForm2.runningType=competingProductData.runningType;//业态类型
          that.ruleForm2.tradeStock=competingProductData.tradeStock;//当前库存量（平方米）
          that.ruleForm2.sellingNums=competingProductData.sellingNums;//月均销售套数
          that.ruleForm2.sellPeriod=competingProductData.sellPeriod;//去化周期（月）
          that.ruleForm2.presentedWay=competingProductData.presentedWay;//赠送方式
      ...
      subCompetingProduct:function () {
        ...
        this.$http({
          ...
          data:{
            ...
            "id":0,//项目或竞品ID，新建时传0   // "projectId":this.projectId,
            ...
            "constructionLandArea":that.ruleForm2.constructionLandArea,//建设用地面积（平米）
            "buildingConstructionArea":that.ruleForm2.buildingConstructionArea,//建筑面积（平米）
            "customerDescription":that.ruleForm2.customerDescription,//客户描摹
            ...
            "competitors":that.competitorsId ,//关联项目
          }
        }).then(function (succeed) {
         {
            that.$message({
              showClose: true,
              message:succeed.data.message,
              type: 'error',
              duration:3000,
            });
          }
